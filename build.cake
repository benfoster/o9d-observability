...
Setup(context =>
{
   ...
   Information($"Building Observability with configuration {configuration} on branch {currentBranch.FriendlyName}");
});
...
Task("Build")
    .Does(() => 
    {
        DotNetCoreBuild("Observability.sln", new DotNetCoreBuildSettings 
        {
...
Task("PublishDocs")
    ...
    .Does(() => 
    {
        ...
        GitClone("https://github.com/benfoster/o9d-observability.git", publishFolder, new GitCloneSettings { BranchName = "gh-pages" });
